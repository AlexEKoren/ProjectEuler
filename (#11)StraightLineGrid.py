#finds the product of 4 numbers in a straight line on the grid
...
def main():
    ...
    while z<20:
        while y<17:
            check=grid[z][y]*grid[z][y+1]*grid[z][y+2]*grid[z][y+3]
            if check>final:
                final=check
                print final
                print grid[z][y],grid[z][y+1],grid[z][y+2],grid[z][y+3]
                print z
            y=y+1
        y=0
        z=z+1
    ...
    while z<17:
        print z
        while y<20:
            check=grid[z][y]*grid[z+1][y]*grid[z+2][y]*grid[z+3][y]
            if check>final:
                final=check
                print final
                print grid[z][y],grid[z+1][y],grid[z+2][y],grid[z+3][y],
                print z
            y=y+1
        y=0
        z=z+1
    ...
    while z<17:
        while y<17:
            check=grid[z][y]*grid[z+1][y+1]*grid[z+2][y+2]*grid[z+3][y+3]
            if check>final:
                final=check
                print final
            y=y+1
